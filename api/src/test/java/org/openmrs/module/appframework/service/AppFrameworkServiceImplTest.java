...
public class AppFrameworkServiceImplTest extends BaseModuleContextSensitiveTest {
    ...
    public void setUp() throws Exception {
        ...
        AppDescriptor app1 = new AppDescriptor("app1", "desc1", "label1", "url1", "iconUrl", "tinyIconUrl", 20,
                null, Arrays.asList(new ExtensionPoint("extensionPoint1"), new ExtensionPoint("extensionPoint2")));

        AppDescriptor app2 = new AppDescriptor("app2", "desc1", "label1", "url1", "iconUrl", "tinyIconUrl", 10,
                null, Arrays.asList(new ExtensionPoint("extensionPoint1")));


        Extension ext1 = new Extension("ext1", "app1", "extensionPoint2", "link", "label", "url", 4);
        Extension ext2 = new Extension("ext2", "app1", "extensionPoint2", "link", "label", "url", 3);
        Extension ext3 = new Extension("ext3", "app2", "extensionPoint1", "link", "label", "url", 2);
        Extension ext4 = new Extension("ext4", "", "extensionPoint2", "link", "label", "url", 1);
        Extension ext5 = new Extension("ext5", "", "extensionPoint2", "link", "label", "url", 0);
