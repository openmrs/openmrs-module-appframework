...
@Resource(name = RestConstants.VERSION_1 + "/administrativenotification", supportedClass = AdministrativeNotification.class, supportedOpenmrsVersions = {"1.9.*", "1.10.*", "1.11.*", "1.12.*"})
